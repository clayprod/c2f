          ...
          <div className="glass-card p-5">
            <div className="flex items-center gap-3 mb-3">
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                totalAppreciation >= 0 ? 'bg-green-500/10' : 'bg-red-500/10'
              }`}>
                <i className={`bx ${totalAppreciation >= 0 ? 'bx-trending-up' : 'bx-trending-down'} text-xl ${
                  totalAppreciation >= 0 ? 'text-green-500' : 'text-red-500'
                }`}></i>
              </div>
