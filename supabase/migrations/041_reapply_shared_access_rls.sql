-- Migration: Reapply Shared Access RLS Policies
-- Description:
--   Some environments may have drifted and not applied 028_shared_access_rls.sql.
--   This migration safely re-drops and re-creates the shared-access RLS policies
--   for core tables so invited members can view (and optionally mutate) owner data
--   according to account_members.permissions.
