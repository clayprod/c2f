...
-- NOTE: This function is now managed by the database migration system
-- The actual implementation is in the database and should use user_id (not owner_id)
-- This file is kept for reference but the function is created via apply_migration
      -- Expenses
