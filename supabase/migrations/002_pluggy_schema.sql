...
CREATE TABLE IF NOT EXISTS public.pluggy_accounts (
  ...
  number TEXT,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  UNIQUE(owner_id, pluggy_account_id)
);
...
CREATE TABLE IF NOT EXISTS public.pluggy_transactions (
  ...
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  UNIQUE(owner_id, pluggy_transaction_id)
);
...
CREATE INDEX IF NOT EXISTS idx_pluggy_items_owner_id ON public.pluggy_items(owner_id);
CREATE INDEX IF NOT EXISTS idx_pluggy_accounts_item_id ON public.pluggy_accounts(item_id);
CREATE INDEX IF NOT EXISTS idx_pluggy_accounts_owner_id ON public.pluggy_accounts(owner_id);
...
CREATE INDEX IF NOT EXISTS idx_pluggy_transactions_owner_id ON public.pluggy_transactions(owner_id);
CREATE INDEX IF NOT EXISTS idx_pluggy_sync_logs_item_id ON public.pluggy_sync_logs(item_id);
CREATE INDEX IF NOT EXISTS idx_pluggy_sync_logs_owner_id ON public.pluggy_sync_logs(owner_id);
